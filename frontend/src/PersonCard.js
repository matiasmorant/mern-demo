...
class PersonCard extends Component {
  render() {
    var {first_name, last_name, photo, email, gender, origin} = this.props
    return (
      <PersonCardContainer>
        ...
        <div>
          ...
          <table>
            <tbody>
              <tr><td className="key">Email:</td><td>{email}</td></tr>
              <tr><td className="key">Gender:</td><td>{gender}</td></tr>
              <tr><td className="key">Origin:</td><td>{origin}</td></tr>
            </tbody>
          </table>
        </div>
      </PersonCardContainer>
